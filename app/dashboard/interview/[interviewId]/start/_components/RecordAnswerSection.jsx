...
setLoading(false);}
  ...
  return (
   <div className='flex items-center justify-center flex-col'>
    <div className='flex bg-black flex-col my-20 justify-center items-center rounded-lg p-5'>
...
<Webcam
    ...
    onClick={StartStopRecording}>
      ...
      :
       <h2 className="text-blue-500 flex gap-2"><Mic/>Record Answer</h2>}</Button>
    </div>
  )
}
