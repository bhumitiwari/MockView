...
<h2 className='text-sm text-gray-500'>Find below interview question with correct answer,Your answer and feedback for improvement</h2>
    {feedbackList&&feedbackList.map((item,index)=>(
     ...
     <CollapsibleTrigger className='p-2 bg-secondary rounded-lg flex my-2 justify-between text-left gap-7 w-full'>
     {item.question}<ChevronsUpDownIcon className='h-15 w-20'/>
     </CollapsibleTrigger>
     <CollapsibleContent>
